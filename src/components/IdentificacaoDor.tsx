        ...
        <div className="grid md:grid-cols-3 gap-8">
          {cards.map((card, index) => {
            ...
            return (
              <div 
                key={index}
                className="bg-white p-8 rounded-2xl shadow-elegant hover:shadow-lg transition-all duration-300 text-center group"
              >
                <div className="w-16 h-16 bg-bordeaux/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-bordeaux/20 transition-colors">
                  <IconComponent className="w-8 h-8 text-bordeaux" />
                </div>
