    ...
    <section id="proposta" className="section-padding">
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              return (
                <div key={index} className="flex items-start gap-4 group">
                  <div className="w-12 h-12 bg-gold/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-gold/30 transition-colors">
                    <IconComponent className="w-6 h-6 text-bordeaux" />
                  </div>
                  <div>
          ...
          <div className="bg-gradient-to-br from-bordeaux to-bordeaux-700 rounded-3xl p-8 text-white">
            <h3 className="text-h3 mb-8 text-center">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="flex items-center gap-4">
                  <div className="w-8 h-8 bg-gold rounded-full flex items-center justify-center text-bordeaux font-bold text-sm">
                    {index + 1}
                  </div>
